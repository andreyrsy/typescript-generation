...
const pessoas: Array<string> = new Array<string>("Henrique", "Bruno", "Murilo", "Geandro");
...
pessoas.push("Henrique");
pessoas.unshift("Gabrieli", "Eduardo")
console.log(`\nO indíce da pessoa Eduardo é: ${pessoas.indexOf("Eduardo")}`);

console.log(`A pessoa Henrique existe no array? ${pessoas.includes("Henrique")}`)
